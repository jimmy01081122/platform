module residency_engine (
	...
	input wire clk;
	input wire rst_n;
	localparam signed [31:0] moe_pkg_MAX_EXPERTS = 64;
	localparam signed [31:0] moe_pkg_EID_W = 6;
	input wire [moe_pkg_EID_W:0] cfg_num_experts;
	input wire [moe_pkg_EID_W:0] cfg_capacity;
	input wire in_valid;
	output wire in_ready;
	input wire [63:0] in_cur_mask;
	input wire [63:0] in_fut_mask;
	...
	output wire [5:0] dma_req_expert;
	output wire [0:0] dma_req_kind;
	reg [2:0] state;
	reg [63:0] resident;
	reg [63:0] pending;
	localparam signed [31:0] moe_pkg_TS_W = 32;
...
module dma_model (
	...
	localparam signed [31:0] moe_pkg_MAX_EXPERTS = 64;
	localparam signed [31:0] moe_pkg_EID_W = 6;
	input wire [5:0] req_expert;
	input wire [0:0] req_kind;
	output reg cmpl_valid;
	output reg [5:0] cmpl_expert;
	localparam signed [31:0] moe_pkg_CNT_W = 32;
...
module moe_residency_top (
	...
	wire dma_req_valid;
	wire dma_req_ready;
	wire [5:0] dma_req_expert;
	wire [0:0] dma_req_kind;
	wire cmpl_valid;
	wire [5:0] cmpl_expert;
