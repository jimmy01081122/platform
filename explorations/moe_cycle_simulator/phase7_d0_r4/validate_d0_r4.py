#!/usr/bin/env python3
"""Validate the prospective D0-R4 CPU-only package without network or SSH."""
...
from explorations.moe_cycle_simulator.phase7_d0_r4.controller import (  # noqa: E402
    D0R4Error,
    PACKAGE_ROOT,
    load_package,
    validate_schema,
...
def validate_package() -> dict[str, object]:
    ...
    return {
        ...
        "blockers": [
            ...
            "D0_R4_SAME_HASH_REVIEW_PENDING",
        ],
        "network_free": True,
        "ssh_attempted": False,
        "gpu_queried": False,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.package_dir.resolve() != PACKAGE_ROOT.resolve():
            raise D0R4Error("this validator only accepts the prospective D0-R4 package root")
        result = validate_package()
    except (D0R4Error, OSError, KeyError, TypeError, ValueError) as exc:
