#!/usr/bin/env python3
"""Validate the Phase 7 R12-R4 candidate ledger as an exact file set."""
...
REVIEW_PREFIX = (
    "explorations/moe_cycle_simulator/phase7/governance/r12r4/reviews/"
)
RUN = REPO / (
    "runs/20260801T181451Z__"
    "moe_cycle_simulator_phase7_cpu_governance_r12r4_final__S2"
)
FIXED = {
